...
//Declare the Form Group variable and 
//all of the required variables for the book form before the constructor.
bookForm: FormGroup;
id:string = '';
isbn:string = '';
title:string = '';
...
published_year:string = '';
  ...
  ngOnInit() {
    // add validation for all fields when the component is initiated.
